        ...
        >
          ...
          {dynamicNews.map((news) => (
            <SwiperSlide key={news.id}>
              <Link to={`/berita/${news.slug || news.id}`} className="group block bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 h-full cursor-pointer">
          ...
          <SwiperSlide>
            <a href="https://lensaind.com/esdm-jabar-hentikan-sementara-operasional-tambang-pt-mpb-di-karawang/" target="_blank" rel="noopener noreferrer" className="group block bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
              <div className="relative h-48 overflow-hidden">
                <img src="https://lensaind.com/wp-content/uploads/2026/03/IMG_8916-400x231.webp" alt="ESDM Jabar Hentikan Sementara Operasional Tambang PT MPB di Karawang" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" loading="lazy" decoding="async" />
                <div className="absolute top-4 left-4 bg-primary text-white text-xs font-bold px-3 py-1 rounded-full">15 Mar 2026</div>
              </div>
              <div className="p-6">
                <h3 className="font-heading font-bold text-xl text-dark mb-3 group-hover:text-primary transition-colors line-clamp-2">
